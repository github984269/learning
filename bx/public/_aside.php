...
<?php
    $connect = connect();
    $sql = "SELECT author,created,content FROM comments
    ORDER BY created desc
    LIMIT 0,6";
    $commArr = query($connect,$sql);
    // print_r($commArr);
?>
<div class="aside">
      <div class="widgets">
      ...
      <div class="widgets">
        ...
        <ul class="body discuz">
            ...
            <a href="javascript:;">
                ...
                <div class="txt">
                <p>
                    <span><?php echo $value["author"] ?></span><?php echo intval((strtotime("now")-strtotime($value['created']))/60/60/24/30)?>个月前(<?php echo substr($value['created'],5,5) ?>)说:
                </p>
